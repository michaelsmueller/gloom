...
import { useContractAt, useAsset, useSellerDeposit, useWinner, useBidderDeposit } from 'hooks';
import Auction from 'contracts/Auction.json';
import { formatUnits, formatEther } from '@ethersproject/units';
import { DECIMALS } from 'data/constants';
import { BidderSummaryForm } from 'components';

// eslint-disable-next-line no-unused-vars
export default function BidderSummary({ auctionAddress, rerender }) {
  ...
  return <BidderSummaryForm data={data} />;
}
